...
export default class ListaDependente extends Component<props, state> {
    constructor(props: props) {
        super(props);
        this.state = {
            clientes: ["Ana Souza", "Pedro Rocha", "Samuel Alves", "Lilian Ferreira", "Lucas Silva", "Maria Lima"],
            filteredClientes: ["Ana Souza", "Pedro Rocha", "Samuel Alves", "Lilian Ferreira", "Lucas Silva"],
    ...
    selectCliente = (cliente: string) => {
        const clienteData = { nome: cliente, nomeSocial: "", email: "" };
